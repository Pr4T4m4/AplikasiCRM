    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                {{-- Jika Anda ingin fitur forgot password untuk admin, Anda perlu membuat routes dan view-nya --}}
                {{-- @if (Route::has('admin.password.request'))
                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="{{ route('admin.password.request') }}">
                        Forgot Password?
                    </a>
                @endif --}}
            </div>
