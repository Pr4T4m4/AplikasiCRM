...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Tambah Tingkatan Baru</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.tiers.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="min_points" id="min_points" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('min_points') border-red-500 @enderror" value="{{ old('min_points', 0) }}" min="0" required>
                    @error('min_points')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="max_points" id="max_points" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('max_points') border-red-500 @enderror" value="{{ old('max_points') }}" min="0">
